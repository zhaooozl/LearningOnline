...
import com.example.learn.activity.RegisterActivity;
...
import com.example.learn.delegate.teacher.UploadDelegate;
...
public class StuManagerDelegate extends BaseDelegate implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
        ...
        OKHttp.getInstance()
                .get(url, new RequestCallback() {
                    ...
                    public void onSuccess(String responseBody) {
                        ...
                        UserInfoAdapter userInfoAdapter = new UserInfoAdapter(userInfoBeans, StuManagerDelegate.this);
